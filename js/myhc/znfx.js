requirejs(["common", "ec"], function(sugon, ec) {
  ...
  var tData = [],
    ...
    secondLock = true,
    thirdLock = true;
  var secondChildLock = true,
    thirdChildLock = true;
  var secondLastLock = true,
    thirdLastLock = true;
  var firstLabelLock = true,
    secondLabelLock = true,
    thirdLabelLock = true;
