...
requirejs(["common", "ec"], function (sugon, ec) {
    ...
    sugon.requestJson({
        ...
        // 加载下拉框
        $(".select_pannel").empty();
        $(".select_pannel").append("<option value='0'>" + allData.title.substring(6, title.length) + "</option>");
        $(".select_pannel").append("<option value='1'>" + allData.data1[0].name + "</option>");
        $(".select_pannel").append("<option value='2'>" + allData.data2[0].name + "</option>");
    ...
    var initPie = function () {
        ...
        for (var i = 0; i < allData.data1.length; i++) {
            pieData1.push({name: allData.data1[i].name, value: allData.data1[i].value1});
        }
        for (var i = 0; i < allData.data2.length; i++) {
            pieData2.push({name: allData.data2[i].name, value: allData.data2[i].value1});
        }
