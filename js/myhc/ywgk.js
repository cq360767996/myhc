...
//----------------------------------------------------------------------------------------------------------------------
    ...
    var initContent1 = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var tempPath = "../../img/myhc/dwjx/" + data[i].icon + ".png";
            $("#chart1").append(
                "<div>" +
                "<div class='newName'>" +
                "<img src=" + tempPath + " />" +
                "<span>" + data[i].txt + "</span>" +
                "</div>" +
                "<div class='newValue'>" +
                "<div class='newLabel'>" + data[i].name + "</div>" +
                "<div class='newValue2'>" + data[i].value2 + "条</div>" +
                "</div>" +
                "</div>");
        }
    };
    ...
    var initChart = function (obj) {
        ...
        sugon.requestJson({
            ...
            if (result.timestamp == timestamp) {
                ...
                // else if(result.timestamp==timestamp){
                //     timestamp = (new Date()).getTime();
                // }
                if (count != 0) {
