requirejs([], () => {
  ...
  function closeComponent() {
    // 1.移除容器 2.清空计时器 3.重置图片序列 4.重置tips的index 5.重置是否开始循环
    $(".box-popup").remove();
  ...
  function initComponent() {
    const result = {
      data: [
        { name: "微警务评价", value: 245 },
        { name: "微信调查", value: 245 },
        { name: "党代表", value: 245 },
        { name: "人大代表", value: 245 },
        { name: "政协委员", value: 245 },
        { name: "12345热线", value: 245 },
        { name: "短信回访", value: 245 },
        { name: "电话回访", value: 245 },
        { name: "二维码门牌", value: 245 }
      ]
    };
    ...
    <div class="box-popup">
      <div class="box-popup__ball">
        <img src="../../img/myhc/myzs/animate/earth/earth000.png" />
      </div>
    </div>`);
    // 开启球体运动
    startBall();
  ...
  // 开始按钮事件
  $(".start").on("click", initComponent);

  // 结束事件
  $(".end").on("click", closeComponent);
