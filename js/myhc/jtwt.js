...
//----------------------------------------------------------------------------------------------------------------------
    ...
    var initPie3D = function() {
        ...
        for(var i=0;i<oldData.length;i++) {
            ...
            $("div.title").eq(2).html(chooseStr + "数量分析");
            var ele = "pie_3D" + (i + 1);
    ...
    var initOtherCharts = function() {
        sugon.requestJson({
            ...
            data: {type: "jtwt", nav: JSON.stringify(navigorData),timestamp:timestamp, code: searchRule.code, position:1, date1: searchRule.date1, date2: searchRule.date2},
            async: true
        }, function (result) {
        ...
        sugon.requestJson({
            type: "POST",
            url: sugon.interFaces.dwjx.OtherCharts,
            data: {type: "jtwt", nav: JSON.stringify(navigorData),timestamp:timestamp, code: searchRule.code, position:2, date1: searchRule.date1, date2: searchRule.date2},
            async: true
        }, function (result) {
            if(result.timestamp == timestamp)
        ...
        sugon.requestJson({
            type: "POST",
            url: sugon.interFaces.dwjx.OtherCharts,
            data: {type: "jtwt", nav: JSON.stringify(navigorData),timestamp:timestamp, code: searchRule.code, position:3, date1: searchRule.date1, date2: searchRule.date2},
            async: true
        }, function (result) {
            if(result.timestamp == timestamp)
        ...
        sugon.requestJson({
            type: "POST",
            url: sugon.interFaces.dwjx.OtherCharts,
            data: {type: "jtwt", nav: JSON.stringify(navigorData),timestamp:timestamp, code: searchRule.code, position:4, date1: searchRule.date1, date2: searchRule.date2},
            async: true
        }, function (result) {
            if(result.timestamp == timestamp)
    ...
    var initChart = function(obj) {
        ...
        sugon.requestJson({
            ...
            data: {type: "jtwt", nav: JSON.stringify(navigorData),timestamp:timestamp, code: searchRule.code, date1: searchRule.date1, date2: searchRule.date2},
            async: true
        }, function (result) {
