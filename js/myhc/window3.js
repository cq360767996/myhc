...
requirejs(["common", "ec"], function (sugon, ec) {
    ...
    sugon.requestJson({
        ...
        for (var i = 0; i < result.data1.length; i++) {
            $(".select_pannel").append("<option value=" + i + ">" + result.data1[i].name + "</option>");
        }
    });
    ...
    var initRador = function () {
        ...
        for (var i = 1; i < allData.data1.length; i++) {
            indicatorData.push({text: allData.data1[i].name, max: allData.data1[i].value1});
                ...
                angleAxis: {
                    ...
                    axisLabel: {
                        ...
                        formatter: function (param, index) {
                            ...
                            var str = "{color2|" + tempStr + "}" + "{color1|" + tempValue + "}";
                            return str;
                        },
                        rich: {
                            color1: {
    ...
    var initBar = function (index) {
        ...
        if (allData.dwType == '1') {
            ...
            if ($(".myd-gd").eq(0).hasClass('selected')) {
                suffix = "数值";
            ...
            if ($("#tempTYPE").val() == '1' || $("#tempTYPE").val() == '2' || $("#tempTYPE").val() == '3') {
                ...
                suffix = "不满意工单数量";
                titleTxt = params[1].replace("满意度", "").replace("评价指数", "") + '不满意工单情况';
                $(".second-switch").hide();
                $(".third-switch").hide();
            }
        }
    ...
    var initChart = function () {
        ...
        if (allData.data3.length > 0) {
            $(".lkj").eq(0).click();
            $(".myd-gd").eq(0).click(); // 查询到数据点击一次满意度
