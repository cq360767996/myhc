...
requirejs(["common", "ec", 'jqcloud'], function (sugon, ec) {
    ...
    var initUser = function () {
        sugon.requestJson({
            ...
            for (var i = 0; i < result.data3.length; i++) {
                $("#typeList").append("<div><span>" + result.data3[i].name + "：</span><span class='b'>" + result.data3[i].value + "</span></div>");
            }
        });
    };
    ...
    var initLine = function () {
        sugon.requestJson({
            ...
            var xData = [], yData1 = [], yData2 = [], yData3 = [], iData = [], min = result.data[0].value,
